        ...
        <View style={{ margin: "15px" }}>
          <View style={{ textAlign: "center", margin: "15px 0" }}>
            <Text style={{ fontWeight: "bold" }}>
              Reporte de pedidos de {isCustomer ? data[0].customer : data[0].messenger} entre{" "}
              {headers.months[0]} y {headers.months[1]}
            </Text>
          </View>

          <View
            style={{ flexDirection: "row", borderBottom: 1, alignItems: "center", margin: "5px" }}
          >
          ...
          {data.map((item, index) => (
            <View
              style={{ flexDirection: "row", alignItems: "center", padding: "5px" }}
              key={index}
            >
